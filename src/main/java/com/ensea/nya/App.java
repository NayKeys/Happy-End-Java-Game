...
public class App {
  ...
  // Cursors
  private static Cursor DEFAULT_CURSOR, HAND_CURSOR, LOADING_CURSOR, MOVE_CURSOR, TEXT_CURSOR, RESIZE_LEFT_CURSOR,
      RESIZE_TOP_CURSOR, RESIZE_TOP_RIGHT_CURSOR, RESIZE_TOP_LEFT_CURSOR;
