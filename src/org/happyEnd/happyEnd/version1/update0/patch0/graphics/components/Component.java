...
public abstract class Component extends AbstractComponent {
	...
	public Component() {
		super(Launcher_HappyEnd.getGameContainer());
		this.input = Launcher_HappyEnd.getGameContainer().getInput();
		showComponents = true;
	...
	public boolean isEntered() {
		if (entered) {
			if (showComponents) {
				ArrayList<Component> components = Launcher_HappyEnd.getCurrentState().components.getAllComponents();
